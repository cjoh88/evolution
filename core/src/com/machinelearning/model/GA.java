...
//
// //private static final float MUTATION_RATE = 1.0f /
// Environment.NUM_INDIVIDUALS;
// private static final double MUTATION_RANGE = 0.5f;
//
// //private static final Random random = new Random();
//
// //private static final int rankSum =
// Utility.sumNumbers(Environment.NUM_INDIVIDUALS);
//
// private static Comparator<Animal> fitnessComparator = new
// Comparator<Animal>() {
// @Override
// public int compare(Animal a1, Animal a2) {
// return Float.compare(a2.fitness(), a1.fitness());
...
// Animal[] numberOfParents =
// {Selection.rank(population),Selection.rank(population)};
// double [] genome = Crossover.weigthedAvg(numberOfParents, 1);
// Animal p1 = new Animal(population[i].getEnvironment(),
// population[i].getSensors(), population[i].getActions());
// mutate(genome);
// p1.setGenome(genome);
...
// newPopulation[index] = new Animal(population[0].getEnvironment(),
// population[0].getSensors(), population[0].getActions());
// index++;
// }
//
...
// genome[i] += Utility.random.nextDouble() * MUTATION_RANGE * 2 -
// MUTATION_RANGE;
// }
// }
// }
