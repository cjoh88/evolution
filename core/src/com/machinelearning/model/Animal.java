...
public class Animal implements Food {
	...
	public Animal(Environment environment, Sensor[] sensors, Action[] actions, Food[] food) {
		...
		this.position = new Vector2(random.nextFloat() * Config.WIDTH, random.nextFloat() * Config.HEIGHT);
		this.velocity = new Vector2(random.nextFloat() - 0.5f, random.nextFloat() - 0.5f);
